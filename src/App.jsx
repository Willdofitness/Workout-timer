...
// - Create printable PDF report (Print -> Save as PDF)
...
export default function App() {
  ...
  function exportSession() {
    ...
    a.href = url;
    a.download = `gym-session-${state.sessionId}.json`;
  ...
  function createPdfOrShare() {
    // Client-friendly printable report. Users can "Print" -> "Save as PDF".
    // Falls back to share/copy text if popups are blocked.
...
<body>
  ...
  <script>
    ...
    alert("Couldn’t open the PDF view (popup blocked). A text summary was copied instead.");
  }
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="mx-auto max-w-3xl p-4 sm:p-6">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-3xl bg-zinc-900 p-4 sm:col-span-1">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={addExercise}
                className="rounded-2xl bg-zinc-800 px-3 py-1.5 text-sm hover:bg-zinc-700"
              >
                + Add
              </button>
            </div>
                  ...
                  <button
                    ...
                    className={
                      ...
                      (isActive
                        ...
                        : "bg-zinc-950/40 hover:bg-zinc-800/60")
                    }
                  >
        ...
        <footer className="mt-6 text-xs text-zinc-500">
          Autosaves to your device (localStorage). Clearing browser data resets it.
        </footer>
      </div>
    </div>
  );
